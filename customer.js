...
// CHECKOUT CART (UPDATED TO DIRECT YOUR WHATSAPP NUMBER)
function checkoutCart() {
    ...
    // Message structure formatted specially for your business WhatsApp line (+94758487089)
    ...
    // 1. Firebase Database Sync
    fetch(FIREBASE_BASE_URL + "orders.json", {
        method: "POST",
        body: JSON.stringify(orderPayload)
    }).then(() => {
        // Render local receipt interface elements exactly as before
        ...
        // 2. Direct Redirect to YOUR WhatsApp (+94758487089)
        setTimeout(() => {
            const adminWhatsAppLine = "94758487089"; 
            const directWhatsAppUrl = `https://wa.me/${adminWhatsAppLine}?text=${encodeURIComponent(orderMsg)}`;
